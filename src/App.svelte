<script lang="ts">
    ...
    import Explore from "./pages/Explore/Explore.svelte";

    // Components
    import Header from "./components/Header/Header.svelte";
    import LeftMenu from "./components/Menu/Menu.svelte";
    import FixedRightPanel from "./components/Right/Right.svelte";
    import Modal from "./components/Modal/Modal.svelte";

    // Other
    import { user, rank, color } from './scripts/stores.ts';
    import { colorBrightness, hexToRgb } from './scripts/functions.ts';
    ...
    $: cssVarStyles = Object.entries($color)
    ...
    onMount(async () => {
        fetch(`${Config.API_URL}/api/@me/client`)
            ...
            .then(data => {
                ...
                $color['app-color-x1'] = colorBrightness(data.color, -10);
                $color['app-color-s1'] = colorBrightness(data.color, 50);
                $color['app-color-trans'] = hexToRgb(data.color, .5);
            });
...
<svelte:head>
    <title>Glynet</title>
    <meta name="description" content="Glynet, sosyal medyanın yeni şekli" />
    <meta name="theme-color" content="#2aa0ad">
